...
### Create an frontend test api in postman using a API Gateway url 

### create an dist file and upload to s3 bucket

### attach bucket to cloudfront with an origin root as well as proper oac

### similar attach API gateway with cloudfront in its origin 

### update behavior of API Gateaway in cloudfront